...
def get_wikitext2(nsamples, seed, seqlen, tokenizer):
    ...
    import pandas as pd
    # Loaded from https://huggingface.co/datasets/Salesforce/wikitext/tree/main/wikitext-2-raw-v1
    testdata = pd.read_parquet("/root/WeLore/data/test-00000-of-00001.parquet")
    
    # Encode datasets
    valenc = tokenizer(' '.join(testdata['text']), return_tensors='pt')
    valenc = valenc.input_ids[:, :(256 * seqlen)]
    valenc = TokenizerWrapper(valenc)
    return -1, testenc
